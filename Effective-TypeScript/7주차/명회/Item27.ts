...
// '체인' 방식을 통해서 반환 값들의 타입이 잘 전달
// '파이썬', 'C', 'Java' 에서 볼 수 있는 표준 라이브러리가 자바스크립트에는 포함 되어있지 않았다.
// 수년간 많은 라이브러리들은 표준 라이브러리의 역할을 대신하기 위해 노력해왔다.
// 이러한 노력을 바탁으로 로대시(Lodash)가 만들어졌다.
// Lodash 후 자바스크립트 내장 함수 추가
